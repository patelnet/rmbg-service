...
MainWindow::MainWindow() {
    ...
    ContentFrame().Navigate(xaml_typename<BackgroundRemover::HomePage>());
}
...
void MainWindow::NavView_SelectionChanged(
    ...
    if (tag == L"home") {
        ...
        ContentFrame().Navigate(xaml_typename<BackgroundRemover::SettingsPage>());
    }
}
